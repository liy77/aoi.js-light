...
module.exports = async d => {
    ...
    if (!d.client.collections[cname.addBrackets()]) throw new Error(`❌ Invalid collection name in \`$setCollectionKey${inside}\``) 
    ...
    if (temporal) {
        ...
        if (!time) throw new Error(`❌ Invalid temp duration in \`$setCollectionKey${inside}\``) 
