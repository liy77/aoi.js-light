...
const { Collection, Constants, Client } = require("discord.js-light");
...
module.exports = async (Guilds, Channels, Overwrites, Roles, Emojis, Presences) => {
  ...
  cacheChannels = Channels || cacheChannels;
  cacheOverwrites = Overwrites || cacheOverwrites;
  cacheRoles = Roles || cacheRoles;
  cacheEmojis = Emojis || cacheEmojis;
  cachePresences = Presences || cachePresences;
}
...
client.voice_state_update_commands = new Collection();
client.member_update_commands = new Collection();
client.loop_commands = new Collection();
client.channel_update_commands = new Collection();
client.channel_delete_commands = new Collection();
client.channel_create_commands = new Collection();
client.role_delete_commands = new Collection();
client.role_update_commands = new Collection();
client.role_create_commands = new Collection();
client.presence_commands = new Collection();
client.user_update_commands = new Collection();
client.ratelimit_commands = new Collection();
client.timeout_commands = new Collection();
client.typing_commands = new Collection();
client.slash_commands = new Collection();
client.invite_create_commands = new Collection();
client.bot_leave_commands = new Collection();
client.invite_delete_commands = new Collection();
client.ban_add_commands = new Collection();
client.ban_remove_commands = new Collection();
client.music_start_commands = new Collection();
client.music_end_commands = new Collection();
client.bot_join_commands = new Collection();
client.collections = {};
client.servers = new Collection();
client.update_commands = new Collection();
client.join_commands = new Collection();
client.bot_commands = new Collection();
client.deleted_commands = new Collection();
client.ready_commands = new Collection();
client.variables = {};
client.statuses = new Collection();
client.leave_commands = new Collection();
client.awaited_commands = new Collection();
client.reaction_add_commands = new Collection();
client.reaction_remove_commands = new Collection();
client.timeout_pulse_commands = new Collection();
...
module.exports = class Client {
  constructor(
    ...
    if (options.mobile) {
      Constants.DefaultOptions.ws.properties.$browser =
        "Discord Android";
